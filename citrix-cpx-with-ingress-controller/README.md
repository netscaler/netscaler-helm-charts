...
| image | Mandatory | `quay.io/citrix/citrix-k8s-cpx-ingress:13.0-47.103` | The Citrix ADC CPX image. |
...
| cic.image | Mandatory | `quay.io/citrix/citrix-k8s-ingress-controller:1.7.46` | The Citrix ingress controller image. |

...
| `xDSAdaptor.imageRegistry`			   | Image registry of the NetScaler xDS adaptor container               | `quay.io`               |     Mandatory                  |
| `xDSAdaptor.imageRepository`			   | Image repository of the NetScaler xDS adaptor container               | `citrix/citrix-xds-adaptor`               |    Mandatory                  |
| `xDSAdaptor.imageTag`			   | Image tag of the NetScaler xDS adaptor container               | `0.10.3`               |   Mandatory                  |
...
| `egressGateway.netscalerUrl`       | URL or IP address of the NetScaler which Istio-adaptor configures (Mandatory if citrixCPX=false)| null   |Mandatory for NetScaler MPX or VPX|
| `egressGateway.vserverIP`       | Virtual server IP address on NetScaler (Mandatory if citrixCPX=false) | null | Mandatory for NetScaler MPX or VPX|
| `egressGateway.adcServerName`          | NetScaler ServerName used in the NetScaler certificate  | null            | Optional |
| `egressGateway.imageRegistry`			   | Image registry of NetScaler CPX designated to run as egress Gateway              | `quay.io`               |     Mandatory for NetScaler CPX                  |
| `egressGateway.imageRepository`			   | Image repository of NetScaler CPX designated to run as egress Gateway              | `citrix/citrix-k8s-cpx-ingress`               |    Mandatory for NetScaler CPX                  |
| `egressGateway.imageTag`			   | Image tag of NetScaler CPX designated to run as egress Gateway              | `13.1-30.52`               |   Mandatory for NetScaler CPX                  |
| `egressGateway.imagePullPolicy`   | Image pull policy                                                                                                                  | IfNotPresent                                                          | Optional|
| `egressGateway.mgmtHttpPort`      | Management port of the NetScaler CPX                                                                                              | 9080                                                                  | Optional|
| `egressGateway.mgmtHttpsPort`    | Secure management port of NetScaler CPX                                                                                           | 9443                                                                  | Optional|
| `egressGateway.EULA`             | End User License Agreement(EULA) terms and conditions. If yes, then user agrees to EULA terms and conditions.                                     | false                                                                    | Mandatory for NetScaler CPX

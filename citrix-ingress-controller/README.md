...
| profileSslFrontend | Optional | N/A | Specify the default front end profile. The default ADC front end profile `ns_default_ssl_profile_frontend` is not supported, see [Configuration using FRONTEND_SSL_PROFILE](https://docs.citrix.com/en-us/citrix-k8s-ingress-controller/configure/profiles.html#global-front-end-profile-configuration-using-configmap-variables) |

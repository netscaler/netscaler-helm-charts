...
| cic.image | Mandatory | `quay.io/citrix/citrix-k8s-ingress-controller:1.9.2` | The CIC image. |
...
| cic.exporter.image    | Optional | `quay.io/citrix/citrix-adc-metrics-exporter:1.4.5` | The Exporter image. |

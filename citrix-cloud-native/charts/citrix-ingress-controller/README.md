...
| cic.image | Mandatory | `quay.io/citrix/citrix-k8s-ingress-controller:1.7.46` | The CIC image. |
...
| cic.exporter.image    | Optional | `quay.io/citrix/citrix-adc-metrics-exporter:1.4.2` | The Exporter image. |

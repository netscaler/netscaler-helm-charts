...
| cpx.cic.image | Mandatory | `quay.io/citrix/citrix-k8s-ingress-controller:1.17.13` | The Citrix ingress controller image. |
...
| cpx.serviceSpec.loadBalancerSourceRanges | Optional | N/A | Provide the list of IP Address or range which should be allowed to access the Network Load Balancer. For details, see [Network Load Balancer support on AWS](https://kubernetes.io/docs/concepts/services-networking/service/#aws-nlb-support). |

...
To set requests and limits for the Gateway Controller container, use the variables `gatewayController.resources.requests` and `gatewayController.resources.limits` respectively.
...
```
helm install my-release netscaler/netscaler-kubernetes-gateway-controller --set gatewayController.gatewayControllerName=citrix.com/nsgc-controller,license.accept=yes --set gatewayController.resources.requests.cpu=500m,gatewayController.resources.requests.memory=512Mi --set gatewayController.resources.limits.cpu=1000m,gatewayController.resources.limits.memory=1000Mi,gatewayController.entityPrefix=gwy
```
...
| imageTag                                                | Optional              | `3.3.2`                                      | The NetScaler Kubernetes Gateway Controller image tag                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| gatewayController.resources                             | Optional              | {}                                           | CPU/Memory resource requests/limits for NetScaler Ingress Controller container                                                                                                                                                                                                                                                                                                                                                                                       |

...
```
   git clone https://github.com/citrix/citrix-helm-charts.git
   cd citrix-helm-charts/examples/
   helm install citrix-k8s-ingress-controller --set nsIP=<NSIP>,license.accept=yes,nsVIP=<VIP>,openshift=true
```
...
| nsVIP | Mandatory | N/A | The Virtual IP address on the Citrix ADC device. |

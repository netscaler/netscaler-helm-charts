...
| imageTag                  | Mandatory  |  `1.35.6`               |   The Citrix ingress controller image tag            | 
...
| clusterName | Optional | N/A | The unique identifier of the kubernetes cluster on which the CIC is deployed. Used in gslb-controller deployments. |
